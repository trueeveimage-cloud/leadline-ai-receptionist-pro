...
const dict = {
  en: {
    ...
    "hero.signal": "Signal",
    "hero.signal.live": "Live",
    "hero.signal.1": "pickup",
    "hero.signal.2.value": "4 fields",
    "hero.signal.2": "captured",
    "hero.signal.3.value": "sent",
    "hero.signal.3": "summary",
    "hero.saved": "Lead saved",
    "hero.saved.meta": "voicemail dead ends",
    ...
    "proof.eyebrow": "Proof, not promises",
    "proof.title": "The moment they call, the sale is still alive.",
    "proof.body": "Leadmap turns the first ring into a captured buyer, a clean summary, and a next step you can act on.",
    "proof.card.1": "average pickup",
    "proof.card.2": "key details captured",
    "proof.card.3": "after-hours cover",
    "proof.visual.label": "Missed-call rescue",
    "proof.visual.live": "Live proof",
    "proof.missed.title": "Caller is about to try someone else",
    "proof.missed.meta": "The danger zone",
    "proof.bar.1": "Intent still hot",
    "proof.bar.2": "Trust still high",
    "proof.bar.3": "Voicemail chance",
    "proof.saved.eyebrow": "Leadmap saves the handoff",
    "proof.saved.title": "A caller becomes a named, qualified request.",
    "proof.saved.1": "Name and number captured",
    "proof.saved.2": "Need and urgency scored",
    "proof.saved.3": "Summary sent to owner",
  ...
  sv: {
    ...
    "hero.signal.live": "Live",
    "hero.signal.1": "svar",
    "hero.signal.2.value": "4 fält",
    "hero.signal.2": "fångade",
    "hero.signal.3.value": "skickad",
    "hero.signal.3": "summary",
    "hero.saved": "Lead räddat",
    "hero.saved.meta": "inga voicemail-dödlägen",
    ...
    "proof.eyebrow": "Bevis, inte löften",
    "proof.title": "När kunden ringer är affären fortfarande levande.",
    "proof.body": "Leadmap gör första signalen till en fångad kund, en ren sammanfattning och ett nästa steg du kan agera på.",
    "proof.card.1": "genomsnittligt svar",
    "proof.card.2": "viktiga detaljer",
    "proof.card.3": "täckning efter stängning",
    "proof.visual.label": "Räddat missat samtal",
    "proof.visual.live": "Live-bevis",
    "proof.missed.title": "Kunden är på väg att testa nästa företag",
    "proof.missed.meta": "Riskzonen",
    "proof.bar.1": "Intent fortfarande varm",
    "proof.bar.2": "Förtroende kvar",
    "proof.bar.3": "Risk för voicemail",
    "proof.saved.eyebrow": "Leadmap räddar överlämningen",
    "proof.saved.title": "En uppringare blir en namngiven, kvalificerad förfrågan.",
    "proof.saved.1": "Namn och nummer fångas",
    "proof.saved.2": "Behov och brådska poängsätts",
    "proof.saved.3": "Sammanfattning skickas till ägaren",
  ...
  es: {
    ...
    "hero.signal": "Señal",
    "hero.signal.live": "En vivo",
    "hero.signal.1": "respuesta",
    "hero.signal.2.value": "4 datos",
    "hero.signal.2": "captados",
    "hero.signal.3.value": "enviado",
    "hero.signal.3": "resumen",
    "hero.saved": "Lead salvado",
    "hero.saved.meta": "sin callejón de buzón",
    ...
    "proof.eyebrow": "Pruebas, no promesas",
    "proof.title": "Cuando llaman, la venta sigue viva.",
    "proof.body": "Leadmap convierte el primer tono en un cliente capturado, un resumen limpio y un siguiente paso accionable.",
    "proof.card.1": "respuesta media",
    "proof.card.2": "datos clave captados",
    "proof.card.3": "cobertura fuera de horario",
    "proof.visual.label": "Rescate de llamada perdida",
    "proof.visual.live": "Prueba en vivo",
    "proof.missed.title": "El cliente está a punto de llamar a otro",
    "proof.missed.meta": "Zona de riesgo",
    "proof.bar.1": "Intención aún caliente",
    "proof.bar.2": "Confianza aún alta",
    "proof.bar.3": "Riesgo de buzón",
    "proof.saved.eyebrow": "Leadmap salva el traspaso",
    "proof.saved.title": "Una llamada se convierte en una solicitud nombrada y calificada.",
    "proof.saved.1": "Nombre y número captados",
    "proof.saved.2": "Necesidad y urgencia puntuadas",
    "proof.saved.3": "Resumen enviado al dueño",
