...
const dict = {
  en: {
    ...
    "hero.trust.4": "Keep your current number",
    ...
    "stats.value.language": "Swedish",
    "stats.value.pilot": "7 days",
    "stats.voicemail": "Default language",
    "stats.pickup": "Pricing currency",
    "stats.coverage": "Pilot period",
    "stats.live": "Contact options",
    ...
    "pricing.pilot.cta": "Request 7-day pilot",
    "pricing.pilot.price": "2 900",
    "pricing.pilot.currency": "kr",
    "pricing.pilot.note": "+ 2 000 kr setup · 7-day pilot",
    "pricing.pilot.sub": "A controlled way to test the service.",
    "pricing.pilot.f1": "500 minutes included, then 2.50 kr/min",
    ...
    "pricing.premium.cta": "Book free demo",
    "pricing.premium.price": "4 900",
    "pricing.premium.currency": "kr",
    "pricing.premium.note": "Setup included · cancel anytime",
    "pricing.premium.sub": "For businesses with higher call volume.",
    "pricing.premium.f1": "1,500 minutes included, then 2.50 kr/min",
    ...
    "booking.industry.vvs": "Plumbing company",
    "booking.industry.electrician": "Electrician",
    "booking.industry.other": "Other",
    "booking.missedCalls": "Approximate missed calls per week",
    "booking.contactMethod": "Preferred contact method",
    "booking.contact.email": "Email",
    "booking.contact.sms": "SMS",
    "booking.contact.video": "Video meeting",
    "booking.request.demo": "Free demo",
    "booking.request.pilot": "7-day pilot",
    "booking.step.company": "Your company",
    "booking.step.needs": "Your needs",
    ...
    "booking.videoHint": "Choose a video meeting time",
    "booking.required": "Required",
    "booking.invalidEmail": "Enter a valid email",
    "booking.invalidPhone": "Enter a valid mobile number",
    "booking.privacyConsent": "I agree that Leadmap may process my details to respond to this request.",
    "booking.private": "GDPR-conscious · never sold",
    "booking.date": "Date",
    "booking.time": "Time",
    ...
    "booking.success.body": "Thanks {name}. We received your request and will respond through your selected contact method.",
  ...
  sv: {
    ...
    "hero.title.l1": "Missa aldrig en",
    "hero.title.l2": "värdefull kund",
    "hero.title.l3": "igen.",
    "hero.subtitle": "Leadmap svarar när du inte kan, kvalificerar kunden och skickar nästa steg direkt till dig.",
    "hero.cta.book": "Boka en kostnadsfri demo",
    ...
    "hero.trust.2": "Redo inom 7 dagar",
    "hero.trust.3": "Ingen bindningstid",
    "hero.trust.4": "Behåll ditt nuvarande nummer",
    ...
    "stats.value.language": "Svenska",
    "stats.value.pilot": "7 dagar",
    "stats.voicemail": "Standardspråk",
    "stats.pickup": "Prisvaluta",
    "stats.coverage": "Pilotperiod",
    "stats.live": "Kontaktvägar",
    ...
    "pricing.pilot.name": "Pilot",
    "pricing.pilot.cta": "Begär 7-dagars pilot",
    "pricing.pilot.price": "2 900",
    "pricing.pilot.currency": "kr",
    "pricing.pilot.note": "+ 2 000 kr i startavgift · 7 dagars pilot",
    "pricing.pilot.sub": "Ett kontrollerat sätt att testa tjänsten.",
    "pricing.pilot.f1": "500 minuter ingår, sedan 2,50 kr/min",
    "pricing.pilot.f2": "AI-receptionist",
    ...
    "pricing.premium.name": "Premium",
    "pricing.premium.cta": "Boka kostnadsfri demo",
    "pricing.premium.price": "4 900",
    "pricing.premium.currency": "kr",
    "pricing.premium.note": "Startavgift ingår · säg upp när du vill",
    "pricing.premium.sub": "För företag med högre samtalsvolym.",
    "pricing.premium.f1": "1 500 minuter ingår, sedan 2,50 kr/min",
    ...
    "booking.phone": "Mobilnummer",
    "booking.industry": "Bransch",
    "booking.industry.vvs": "VVS-företag",
    "booking.industry.electrician": "Elektriker",
    "booking.industry.other": "Annan bransch",
    "booking.missedCalls": "Ungefärligt antal missade samtal per vecka",
    "booking.contactMethod": "Önskad kontaktväg",
    "booking.contact.email": "E-post",
    "booking.contact.sms": "SMS",
    "booking.contact.video": "Videomöte",
    "booking.request.demo": "Kostnadsfri demo",
    "booking.request.pilot": "7-dagars pilot",
    "booking.step.company": "Ditt företag",
    "booking.step.needs": "Dina behov",
    "booking.step.review": "Granska",
    "booking.continue": "Fortsätt",
    "booking.back": "Tillbaka",
    "booking.confirm": "Skicka förfrågan",
    "booking.pickDay": "Välj dag",
    "booking.pickTime": "Välj tid",
    "booking.videoHint": "Välj tid för videomöte",
    "booking.required": "Obligatoriskt",
    "booking.invalidEmail": "Ange en giltig e-postadress",
    "booking.invalidPhone": "Ange ett giltigt mobilnummer",
    "booking.privacyConsent": "Jag godkänner att Leadmap behandlar mina uppgifter för att besvara förfrågan.",
    "booking.private": "GDPR-medvetet · säljs aldrig vidare",
    "booking.date": "Datum",
    "booking.time": "Tid",
    ...
    "booking.success.body": "Tack {name}. Vi har tagit emot din förfrågan och återkommer via din valda kontaktväg.",
  ...
  es: {
    ...
    "hero.trust.4": "Conserva tu número actual",
    ...
    "bridge.body": "Una página dedicada recorre cada paso — del primer tono al traspaso calificado — sin saturar la portada.",
    ...
    "stats.value.language": "Sueco",
    "stats.value.pilot": "7 días",
    "stats.voicemail": "Idioma predeterminado",
    "stats.pickup": "Moneda de precios",
    "stats.coverage": "Periodo piloto",
    "stats.live": "Opciones de contacto",
    ...
    "pricing.pilot.cta": "Solicitar piloto de 7 días",
    "pricing.pilot.price": "2 900",
    "pricing.pilot.currency": "kr",
    "pricing.pilot.note": "+ 2 000 kr de alta · piloto de 7 días",
    "pricing.pilot.sub": "Una forma controlada de probar el servicio.",
    "pricing.pilot.f1": "500 minutos incluidos, luego 2,50 kr/min",
    ...
    "pricing.premium.name": "Premium",
    "pricing.premium.cta": "Reservar demo gratuita",
    "pricing.premium.price": "4 900",
    "pricing.premium.currency": "kr",
    "pricing.premium.note": "Alta incluida · cancela cuando quieras",
    "pricing.premium.sub": "Para empresas con mayor volumen de llamadas.",
    "pricing.premium.f1": "1.500 minutos incluidos, luego 2,50 kr/min",
    ...
    "booking.email": "Email",
    "booking.phone": "Número móvil",
    "booking.industry": "Sector",
    "booking.industry.vvs": "Empresa de fontanería",
    "booking.industry.electrician": "Electricista",
    "booking.industry.other": "Otro",
    "booking.missedCalls": "Llamadas perdidas aproximadas por semana",
    "booking.contactMethod": "Método de contacto preferido",
    "booking.contact.email": "Email",
    "booking.contact.sms": "SMS",
    "booking.contact.video": "Videollamada",
    "booking.request.demo": "Demo gratuita",
    "booking.request.pilot": "Piloto de 7 días",
    "booking.step.company": "Tu empresa",
    "booking.step.needs": "Tus necesidades",
    "booking.step.review": "Revisar",
    "booking.continue": "Continuar",
    "booking.back": "Atrás",
    "booking.confirm": "Enviar solicitud",
    "booking.pickDay": "Elige un día",
    "booking.pickTime": "Elige una hora",
    "booking.videoHint": "Elige hora para la videollamada",
    "booking.required": "Obligatorio",
    "booking.invalidEmail": "Introduce un email válido",
    "booking.invalidPhone": "Introduce un móvil válido",
    "booking.privacyConsent": "Acepto que Leadmap trate mis datos para responder a esta solicitud.",
    "booking.private": "Conforme al RGPD · nunca se vende",
    "booking.date": "Fecha",
    "booking.time": "Hora",
    ...
    "booking.success.body": "Gracias {name}. Hemos recibido tu solicitud y responderemos por el método elegido.",
