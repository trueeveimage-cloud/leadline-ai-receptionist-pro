...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      leads: {
        Row: {
          ...
          marketing_submission_id: string | null;
          ...
          website: string | null;
          website_demo_requested: boolean;
          wbraid: string | null;
        };
        Insert: {
          advertising_consent?: boolean;
      ...
      demo_bookings: {
        Row: {
          ...
          has_missed_call_need: boolean;
          id: string;
          is_decision_maker: boolean;
          is_vvs_company: boolean;
          meet_url: string | null;
          name: string;
          phone: string | null;
          starts_at: string;
    ...
    Functions: {
      ...
      reserve_voice_demo_session: {
        Args: { p_client_hash: string; p_language?: string };
        Returns: string;
      };
      read_email_batch: {
